...
// .wrangler/tmp/bundle-eUlqZa/checked-fetch.js
...
// .wrangler/tmp/bundle-eUlqZa/strip-cf-connecting-ip-header.js
...
var SYSTEM_PROMPT = `You are an AI representation of Jeff Shapiro \u2014 not Jeff himself, but an AI that knows his work, background, and thinking well enough to have a real conversation about it.
...
var src_default = {
  async fetch(request, env) {
    ...
    const responseOrigin = allowed ? origin : env.ALLOWED_ORIGIN;
...
// .wrangler/tmp/bundle-eUlqZa/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-eUlqZa/middleware-loader.entry.ts
